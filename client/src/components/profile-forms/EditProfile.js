...
function EditProfile({ profile: { profile, loading }, createUpdateProfile, history, getCurrentProfile }) {
...
export default connect(mapStateToProps, { createUpdateProfile, getCurrentProfile })(withRouter(EditProfile))
